function munit_assert_failed( message, assert_id, varargin )
...
%    function munit_assert_failed( 'values don''t match', 'xyz', 'debug', true )
...
if isempty(condition)
    ...
    [curr_options, options]=transfer_option( curr_options, options, 'supported_fields__' );
