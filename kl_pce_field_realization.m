function [u_i,xi]=kl_pce_field_realization( mu_u_i, u_i_k, u_k_alpha, I_alpha, xi )
% KL_PCE_FIELD_REALIZATION Compute a realization of a random field given by a
% KL and PCE.
%   [U_I,XI]=KL_PCE_FIELD_REALIZATION( MU_U_I, U_I_K, U_K_ALPHA, I_U, XI )
...
%   generated. MU_U_I is the mean value of the field. The field is returned
