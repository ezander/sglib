function [Qn_i_beta, V_qn]=mmse_update_gpc(Q_i_alpha, Y_func, V_q, ym, eps_func, V_eps, p_phi, p_int_mmse, p_qn, p_int_proj, varargin)
...
[Qn_i_beta, V_qn]=mmse_update_gpc_basic(Q_i_beta, YM_func, V_qe, ym, p_phi, p_int_mmse, p_qn, p_int_proj, 'int_grid', int_grid);
