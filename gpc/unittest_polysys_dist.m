...
% Hermite/Gaussian
dist = polysys_dist('h');
assert_equals( polysys_dist('H'), dist, 'same_h');
...
% Legendre/Uniform
dist = polysys_dist('p');
assert_equals( polysys_dist('P'), dist, 'same_p');
...
% ChebyshevT/Arcsine
dist = polysys_dist('t');
assert_equals( polysys_dist('T'), dist, 'same_t');
...
dist = polysys_dist('u');
assert_equals( polysys_dist('U'), dist, 'same_u');
...
dist = polysys_dist('l');
assert_equals( polysys_dist('L'), dist, 'same_l');
