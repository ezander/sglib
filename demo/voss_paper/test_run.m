if ~exist('model_base', 'var') || ~exist('solver_base', 'var') || ~exist('result_base', 'var')
...
solve_model_target=sprintf( './mat/solve-%s.mat', result_base );
solve_model_params=sprintf( './mat/solver_params-%s.mat', result_base );
plot_results_target=sprintf( './mat/results-%s.mat', result_base );
